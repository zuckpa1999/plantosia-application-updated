...
export default function QuestionScreen10({ navigation }) {
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.greenArea}>
                ...
                <TemplateQuestion index={8} />
                <TouchableOpacity style={styles.confirmButtonContainer} onPress={() => navigation.navigate('Question11')}>
