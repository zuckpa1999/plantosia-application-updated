...
export default function QuestionScreen13({ navigation }) {
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.greenArea}>
                ...
                <TemplateQuestion index={11} />
                <TouchableOpacity style={styles.confirmButtonContainer} onPress={() => navigation.navigate('Question14')}>
