...
export default function QuestionScreen11({ navigation }) {
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.greenArea}>
                ...
                <TemplateQuestion index={9} />
                <TouchableOpacity style={styles.confirmButtonContainer} onPress={() => navigation.navigate('Question12')}>
