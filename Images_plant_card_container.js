export const Images_plant_card_container = {
    "Ixora Coccinea": require('./asset/Plant_Image_card_container/ดอกเข็ม.png'),
    "Mucuna Pruriens": require('./asset/Plant_Image_card_container/หมามุ้ย.png'),
