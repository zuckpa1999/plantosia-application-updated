...
export default function QuestionScreen5({ navigation }) {
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.greenArea}>
                ...
                <TemplateQuestion index={3} />
                <TouchableOpacity style={styles.confirmButtonContainer} onPress={() => navigation.navigate('Question6')}>
