...
export default function QuestionScreen4({ navigation }) {
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.greenArea}>
                ...
                <TemplateQuestion index={2} />
                <TouchableOpacity style={styles.confirmButtonContainer} onPress={() => navigation.navigate('Question5')}>
